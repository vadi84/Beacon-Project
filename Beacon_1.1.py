...
def on_message(client, userdata, msg):
    ...
    if msg.payload == b'meet':  # FORMAL MEETING
        ...
        while (temp_varloop != True):
            print("On_Message")
            for x in range(0, 17):
                pixels[x] = (255,255, 255)  # Light Blue GRB
            time.sleep(1)
            for x in range(0,17):
                pixels[x]=(0,0,0)
            time.sleep(1)
            ...
            if (GPIO.input(6) == True):  # NO
                ...
                temp_varloop == True
            elif {(GPIO.input(23) == True) | | (GPIO.input(24) == True) | | (GPIO.input(25) == True) | | (
                    GPIO.input(26) == True)}:
        ...
        while (temp_varloop != True):
            ...
            if (GPIO.input(6) == True):  # NO
                ...
                yes()
                temp_varloop == True
            elif (GPIO.input(22) == True | | GPIO.input(24) == True | | GPIO.input(25) == True | | GPIO.input(
                    26) == True):
                print("Only Press YES or NO")
        ...
        while (temp_varloop != True):
            ...
            if (GPIO.input(6) == True):  # NO
                ...
                for x in range(0, 17):
                    pixels[x] = (0,255,0)  # Light Blue GRB
                time.sleep(1)
                temp_varloop == True
            elif (GPIO.input(22) == True | | GPIO.input(23) == True | | GPIO.input(25) == True | | GPIO.input(
                    26) == True):
                print("Only Press YES or NO")
        ...
        while (temp_varloop != True):
            ...
            if (GPIO.input(6) == True):  # NO
                ...
                time.sleep(1)
                temp_varloop == True
            elif (GPIO.input(22) == True | | GPIO.input(23) == True | | GPIO.input(24) == True | | GPIO.input(
                    26) == True):
                print("Only Press YES or NO")
